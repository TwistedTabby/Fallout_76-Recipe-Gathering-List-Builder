export const strings = {
  appTitle: 'Twisted Tabby\'s Fallout 76 Tools',
  general: {
    home: 'Home',
  },
  categories: {
  ...
  gatheringList: {
    ...
    empty: 'No recipes selected',
    totalIngredients: 'Total Ingredients Needed',
    addRecipe: 'Add to Gathering List',
    removeRecipe: 'Remove from Gathering List',
    clearList: 'Clear List'
  },
  recipes: {
    title: 'Recipes',
    filterByCategory: 'Filter by Category',
    filterByBuffCategory: 'Filter by Buff Category',
